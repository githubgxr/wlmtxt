	...
	<div style="margin: 50px 0 0 260px; width: calc(100% - 260px);">
		...
		<div style="width: 100%; float: right; margin: 0 15% 20px 0;">
			...
			<div style="float: right; margin-right: 30px;">
				<input type="text" id="queryTitle" class="form-control" style="width: 300px;"  placeholder="请输入管理员账号">
			</div>
		</div>
		...
		<table style="width: 95%; margin: 20px auto; text-align: center;"
			...
			<tr>
					<td>root</td>
					<td>root</td>
					<td>2018-3-3 14:21</td>
					<td><input type="checkbox" /></td>
			</tr>
			<tr>
					<td>1</td>
					<td>1</td>
					<td>2018-3-1 14:21</td>
					<td><input type="checkbox" /></td>
			</tr>
			<tr>
					<td>2</td>
					<td>2</td>
					<td>2018-2-3 14:21</td>
					<td><input type="checkbox" /></td>
			</tr>
			<tr>
					<td>3</td>
					<td>3</td>
					<td>2018-1-3 14:21</td>
					<td><input type="checkbox" /></td>
			</tr>
			<tr>
					<td>aa</td>
					<td>aa</td>
					<td>2017-3-3 14:21</td>
					<td><input type="checkbox" /></td>
			</tr>
		</table>
		...
		<button class="btn btn-danger"
			style="float: right; margin: 20px 15% 0 0;" id="deleteAdmin"
			onclick="deleteCarousel()">删除管理员</button>
