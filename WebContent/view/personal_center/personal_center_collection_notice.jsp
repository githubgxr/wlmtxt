...
<body>
	<div class="wlmtxt_main">
		...
		<div class="wlmtxt_container">
			...
			<div id="llls_main" class="main_container" style="margin-bottom:30px;">
				<!--浏览历史头部-->
					...
					<%-- <div id="llls_list_container">
							<div class="video_options">
										<div class="neck_name user_img_small">
											<img class="user_img_small " src="<%=basePath%>css/zb/img/tx.jpg "/>
										</div>
	...
	<script type="text/javascript">
		...
		$.each(clearfix_a, function(i) {
			...
			if ($(".collection_notice").html() == clearfix_a_html) {
