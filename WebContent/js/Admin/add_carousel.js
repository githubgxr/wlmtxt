window.onload = function() {
	...
	// 获得新闻分页
	/*onload_works("/xxyjsjgcxy/scarousel/scarousel_getNews?page=" + page);*/
	onload_works("/wlmtxt/Admin/Admin_list_carousel?page=" + page);
	...
	function httpBackNews() {
		if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
			...
			tablec.innerHTML = "<tr><th>编号</th><th>封面</th><th>标题</th><th>是否选中</th></tr>";
