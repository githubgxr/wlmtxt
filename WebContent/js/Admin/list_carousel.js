window.onload = function() {
	...
	// 获得新闻分页
	onload_works("/xxyjsjgcxy/scarousel/scarousel_getCarouselImg?page=" + page
			+ "&queryType=" + queryType);
	function onload_works(url) {
	...
	next.onclick = function() {
		...
		if (page >= totalPage) {
			...
			page++;
			imgNumber = 0;
			onload_works("/xxyjsjgcxy/scarousel/scarousel_getCarouselImg?page="
...
/*
	...
	query.onchange = function() {
		...
		page = 1;
		onload_works("/wlmtxt/Admin/Admin_list_carousel?page="
				+ page + "&queryType=" + queryType);
	}
*/
