...
public class UserAction extends ActionSupport {
	...
	public void sendRegisterMail() throws IOException {
		...
		// String href =
		// "http://localhost:8080/wlmtxt/User_registerUser?accpet_user.user_mail="+accpet_user.getUser_mail()+"&accpet_user.user_password="+accpet_user.getUser_password()+"&accpet_user.user_username"+accpet_user.getUser_username();
