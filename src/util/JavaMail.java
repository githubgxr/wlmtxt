...
public class JavaMail {
	...
	private static Message createMessage(Session session, String mailcontent, String mailTo) throws AddressException, MessagingException, UnsupportedEncodingException {
        MimeMessage message = new MimeMessage(session);
        message.setFrom(new InternetAddress("1074545235@qq.com"));
        message.setRecipient(Message.RecipientType.TO, new InternetAddress(mailTo));
//        message.setRecipient(Message.RecipientType.TO, new InternetAddress("guanyangchun@126.com"));
